    ...
    <Stack.Navigator>
      {user ? (
        ...
        <>
          ...
          <Stack.Screen name="Menu" component={MenuRepetition} options={{ headerShown: false }} />
          ...
          <Stack.Screen name="flashcardCaja" component={FlashcardCaja} options={{ headerShown: false }} />
